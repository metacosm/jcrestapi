...
public class RESTEasyActivator implements BundleActivator {
    ...
    public void start(BundleContext bundleContext) throws Exception {
        ...
        resteasyService.addSingletonResource(API.API_PATH + "/*", new API());
    }


    @Override
    public void stop(BundleContext bundleContext) throws Exception {
        resteasyService.removeSingletonResource(API.API_PATH + "/*", API.class);


        serviceTrackerForResteasyService.close();
        serviceTrackerForResteasyService = null;
    }
}